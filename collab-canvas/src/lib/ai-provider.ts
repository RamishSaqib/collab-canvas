...
"Delete the red circle":
{"success":true,"commands":[{"intent":"delete","entities":{"query":{"color":"#ff0000","type":"circle","limit":1}}}]}

"Delete the rectangle":
{"success":true,"commands":[{"intent":"delete","entities":{"query":{"type":"rectangle","limit":1}}}]}
...
"Move the blue circle to (50, 100)":
{"success":true,"commands":[{"intent":"move","entities":{"query":{"color":"#0000ff","type":"circle","limit":1},"position":{"x":50,"y":100}}}]}

"Move selected shapes 20 pixels right":
{"success":true,"commands":[{"intent":"move","entities":{"query":{"selected":true},"position":{"x":20,"y":0}}}]}

"Make the rectangle 200 by 150":
{"success":true,"commands":[{"intent":"resize","entities":{"query":{"type":"rectangle","limit":1},"size":{"width":200,"height":150}}}]}

"Make the circle bigger":
{"success":true,"commands":[{"intent":"resize","entities":{"query":{"type":"circle","limit":1},"size":{"scale":1.25}}}]}

"Make the rectangle bigger":
{"success":true,"commands":[{"intent":"resize","entities":{"query":{"type":"rectangle","limit":1},"size":{"scale":1.25}}}]}

"Make selected shapes bigger":
{"success":true,"commands":[{"intent":"resize","entities":{"query":{"selected":true},"size":{"scale":1.25}}}]}

"Make the circle smaller":
{"success":true,"commands":[{"intent":"resize","entities":{"query":{"type":"circle","limit":1},"size":{"scale":0.75}}}]}

"Make the rectangle smaller":
{"success":true,"commands":[{"intent":"resize","entities":{"query":{"type":"rectangle","limit":1},"size":{"scale":0.75}}}]}

"Make selected shapes smaller":
{"success":true,"commands":[{"intent":"resize","entities":{"query":{"selected":true},"size":{"scale":0.75}}}]}

"Rotate the square 45 degrees":
{"success":true,"commands":[{"intent":"rotate","entities":{"query":{"type":"rectangle","limit":1},"rotation":45}}]}

"Rotate selected shapes 90 degrees":
{"success":true,"commands":[{"intent":"rotate","entities":{"query":{"selected":true},"rotation":90}}]}

"Change the circle to blue":
{"success":true,"commands":[{"intent":"changeColor","entities":{"query":{"type":"circle","limit":1},"color":"#0000ff"}}]}
...
- QUERY SYSTEM: Use "query" field to find shapes
  ...
  * Singular ("the"): {"query":{"type":"circle","limit":1}} - affects ONLY most recent match
  * Plural ("all"): {"query":{"type":"circle"}} - affects ALL matches (no limit)
  * CRITICAL: Use "limit":1 for "the X", omit limit for "all X" or "X" (plural)
...
- RESIZE: Change size
  * Rectangle: {"size":{"width":200,"height":150}} - absolute size
  * Circle: {"size":{"radius":75}} - absolute size
  * Bigger: {"size":{"scale":1.25}} - increase by 25%
  * Smaller: {"size":{"scale":0.75}} - decrease by 25%
